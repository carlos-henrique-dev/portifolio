  ...
  return (
    <div className="presentation">
      ...
      <div className="history">
        <p>
          Sou desenvolvedor front end há 2 anos. Possuo experiência com HTML5, JS, CSS3, TypeScript e bibliotecas e
          frameworks como React, Next.js, GraphQl, entre outras.
        </p>
